...
class Type_Convertor(object):
    ...
    '''
    customized_cnvtor = {}
    filter_cnvtor = {"upper":str.upper, "lower":str.lower, "strip":str.strip,
    ...
    def convert(self, cfg_raw_str:str, tmp_cfg_node = None):
        ...
        if typ in Type_Convertor.customized_cnvtor.keys():
            ...
            if isinstance(args, dict):
                ...
                var_val = Type_Convertor.customized_cnvtor[typ]()
        ...
        for method_name in method_lst:
            try:
                var_val = Type_Convertor.filter_cnvtor[method_name](var_val)
            except KeyError:
    ...
    def regist_cnvtor(type_name:str = None, cnvt_func:callable = None):
        ...
        Type_Convertor.customized_cnvtor[type_name] = func_wrap
    ...
    def regist_filter(filter_name:str = None, filter_func:callable = None):
        ...
        Type_Convertor.filter_cnvtor[filter_name] = func_wrap
